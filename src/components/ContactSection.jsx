        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 border border-tierra-100 shadow-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full py-3 bg-terracota-500 hover:bg-terracota-600 text-white rounded-lg font-medium transition-colors"
              >
                Enviar mensaje
              </button>
            </form>
              ...
              <div className="space-y-4">
                {siteConfig.address && (
                  <div className="flex items-start gap-3">
                    <svg className="w-5 h-5 text-terracota-500 mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
