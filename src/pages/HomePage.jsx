...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-white paper-texture">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mt-12">
            <Link
              to="/productos"
              className="inline-flex items-center gap-2 px-8 py-3 bg-tierra-700 hover:bg-tierra-800 text-white rounded-lg font-medium transition-colors no-underline"
            >
      ...
      {/* CTA section */}
      <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-tierra-800 to-oliva-800 text-white relative overflow-hidden">
